...
class EtapasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create etapa" do
    assert_difference('Etapa.count') do
      post etapas_url, params: { etapa: { modalidad_id: @etapa.modalidad_id, nombre: @etapa.nombre } }
    end
  ...
  test "should update etapa" do
    patch etapa_url(@etapa), params: { etapa: { modalidad_id: @etapa.modalidad_id, nombre: @etapa.nombre } }
