...
class ProcesosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proceso" do
    assert_difference('Proceso.count') do
      post procesos_url, params: { proceso: { modalidad_id: @proceso.modalidad_id, numero: @proceso.numero, objeto: @proceso.objeto, palabraclave: @proceso.palabraclave } }
    end
  ...
  test "should update proceso" do
    patch proceso_url(@proceso), params: { proceso: { modalidad_id: @proceso.modalidad_id, numero: @proceso.numero, objeto: @proceso.objeto, palabraclave: @proceso.palabraclave } }
